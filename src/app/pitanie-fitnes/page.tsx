...
export const metadata: Metadata = {
  title: "Питание и фитнес в Калининграде и по России без жестких диет",
  description:
    "Поддержка по питанию для тренировок в Калининграде и по всей России: рацион без экстремальных ограничений, энергия, восстановление и контроль прогресса.",
  alternates: {
  ...
  return (
    <main className="mx-auto w-[min(960px,92%)] py-28 text-[#2a2440]">
      ...
      <p className="mt-4 text-base leading-relaxed text-[#5f5782]">
        Для запросов "питание и фитнес Калининград" и "нутриционное сопровождение Россия" мы используем мягкую стратегию:
        питание под ваш ритм жизни, без срывов и жестких ограничений.
      </p>
