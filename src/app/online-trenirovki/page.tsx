...
export const metadata: Metadata = {
  title: "Онлайн-тренировки с персональным тренером в Калининграде и по России",
  description:
    "Персональные онлайн-тренировки с Марией Кочневой для клиентов из Калининграда и всей России: техника, прогресс, контроль нагрузки и понятный план под ваш график.",
  alternates: {
  ...
  return (
    <main className="mx-auto w-[min(960px,92%)] py-28 text-[#2a2440]">
      ...
      <p className="mt-4 text-base leading-relaxed text-[#5f5782]">
        Если вы ищете запросы вроде "фитнес-тренер Калининград" или "персональные онлайн-тренировки Россия", этот формат
        подойдет: занятия проходят дистанционно, но с персональным контролем техники и регулярной обратной связью.
      </p>
